...
public class Rtradeadapter2 extends RecyclerView.Adapter<Rtradeadapter2.ViewHolder> {

    Context context;
    Rtradelistitem2 item2 = null;
    private ArrayList<Rtradelistitem2> listviewitem;

    public Rtradeadapter2(Context context, ArrayList<Rtradelistitem2> listviewitem) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rtradelayout, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        Rtradelistitem2 item = listviewitem.get(safePosition);
