...
public class RMtradeadapter2 extends RecyclerView.Adapter<RMtradeadapter2.ViewHolder> {

    Context context;
    RMtradelistitem2 item2 = null;
    private ArrayList<RMtradelistitem2> listviewitem;

    public RMtradeadapter2(Context context, ArrayList<RMtradelistitem2> listviewitem) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        RMtradelistitem2 item = listviewitem.get(safePosition);
