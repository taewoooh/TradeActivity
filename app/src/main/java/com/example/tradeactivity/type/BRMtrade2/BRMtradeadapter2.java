...
public class BRMtradeadapter2 extends RecyclerView.Adapter<BRMtradeadapter2.ViewHolder> {

    Context context;
    BRMtradelistitem2 item2 = null;
    private ArrayList<BRMtradelistitem2> listviewitem;

    public BRMtradeadapter2(Context context, ArrayList<BRMtradelistitem2> listviewitem) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        BRMtradelistitem2 item = listviewitem.get(safePosition);
